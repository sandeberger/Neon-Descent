...
export interface HUDState {
  ...
  specialMaxCharges:     number;
  specialChargeProgress: number;
...
export class HUD {
  ...
  private renderSpecialIndicator(ctx: CanvasRenderingContext2D, state: HUDState): void {
    const x = 10;
    const y = CANVAS_H - 30;
  ...
  private drawEdgeGlow(ctx: CanvasRenderingContext2D, tier: number): void {
