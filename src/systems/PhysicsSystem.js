import { GRAVITY, TERMINAL_VELOCITY, MOVE_ACCEL, MOVE_DECEL, MAX_MOVE_SPEED, AIR_STEER, WALL_SLIDE_SPEED, CANVAS_W, } from '@core/Constants';
import { clamp } from '@utils/math';
export class PhysicsSystem {
    update(dt, player, input, moveSpeedMod = 1) {
        player.savePrevious();
