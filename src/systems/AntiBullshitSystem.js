export class AntiBullshitSystem {
    ...
    filterAndWeight(templates, biomeId) {
        // --- Soft weights (base) ---
        const prefs = new Map();
        prefs.set('combat', 4);
        ...
        const highIntensity = ['combat', 'elite', 'hazard'];
    ...
    recordChunk(category) {
        ...
        if (this.recentCategories.length > 8)
