...
export class AcidWyrm extends EnemyBase {
    constructor() {
        ...
        this.posHistory = [];
        this.historyTimer = 0;
        this.HISTORY_INTERVAL = 0.05;
        this.MAX_SEGMENTS = 4;
        // Sine wave params
        this.SINE_AMPLITUDE = 60;
        this.DRIFT_SPEED = 30;
    }
    onUpdate(dt, playerX, playerY) {
        ...
        // Clamp
        if (this.baseX < amplitude + 10)
            this.baseX = amplitude + 10;
        if (this.baseX > 360 - amplitude - 10)
            this.baseX = 360 - amplitude - 10;
