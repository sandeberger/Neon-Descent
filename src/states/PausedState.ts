...
import type { AccessibilityConfig } from '@systems/AccessibilitySettings';

type PauseView = 'main' | 'accessibility';

export class PausedState implements GameState {
  readonly name = 'PAUSED';
  private selectedIndex = 0;
  private readonly options = ['RESUME', 'SETTINGS', 'QUIT TO MENU'];
  private inputCooldown = 0;
  private view: PauseView = 'main';

  // Accessibility settings page
  private readonly settingsOptions: { key: keyof AccessibilityConfig; label: string }[] = [
  ...
  private renderSettingsPage(ctx: CanvasRenderingContext2D): void {
    // Title
    ctx.fillStyle = '#44ddff';
